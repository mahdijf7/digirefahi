...
const AddGroupEmployeeItem = ({ employee, selected = false, onCheckBoxToggled, ...props }) => {
    const { id, full_name, national_code, phone, company_level } = employee;
...
export default AddGroupEmployeeItem;
