...
function NewServiceEditTreeView({ data, onSelect, defaultOpenNodeId, defaultSelectedItem, expandedItems, setExpandedItems }) {
    ...
    useEffect(() => {
        if (defaultSelectedItem) {
            setExpandedItems(defaultOpenNodeId);
        }
    }, []);
    ...
    return (
        <>
            <TreeView
                ...
                defaultSelected={defaultSelectedItem.toString()}
                multiSelect={false}
...
export default NewServiceEditTreeView;
