...
const Ticket = () => {
    ...
    const [breadCrumbLinks, setBreadCrumbLinks] = useState([
        ...
        {path: '/app/dashboard/management-tickets', title: 'پشتیبانی'},
        {path: `/app/dashboard/management-tickets/${ticketId}`, title: ` جزییات تیکت ${ticketId}#`},
    ]);
    ...
    const getTicket=()=>{
        ...
        (async () => {
            await dashboardService.get(`tickets/${ticketId}`, {signal})
                .then((res) => {
                ...
                <Grid container mt="30px" spacing="20px">
                    ...
                    <Grid item xs={7.5}>
                        <DBox sx={{p: '20px 0'}}>
                            ...
                            <Link style={{ textDecoration: 'none',width: '100%',display: 'grid' }} to={`/app/dashboard/management-tickets`}>
                            <Box
                                sx={{
                                    p: '6px 0',
                                    display: 'flex',
