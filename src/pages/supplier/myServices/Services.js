...
const OrganizationServiceBasic = () => {
    ...
    useEffect(() => {
        ...
        (async () => {
            await SupplierService.get(`services?${apiParams.toString()}`)
                .then((res) => {
                                    ...
                                    <Grid container>
                                        ...
                                        <Grid
                                            ...
                                            <Grid container columnSpacing={'20px'} rowSpacing="20px" justifyContent="flex-end">
                                                ...
                                                {/*        searchOnType*/}
                                                {/*        multiple*/}
                                                {/*        apiPath={`supplier/services-get-ticket-type`}*/}
                                                {/*    />*/}
                                                {/*</Grid>*/}
                                                <Grid item xs={3}>
                                                    <DAutoComplete
                            ...
                            <Grid container columnSpacing={'44px'} rowSpacing="30px">
                                ...
                                {services.map((service) => (
                                    <Grid item md={3} xl={2.4} key={service.id}>
                                        <DServiceBox service={service} to={`/app/supplier/my-services/${service.id}`} />
                                    </Grid>
                                ))}
...
const breadCrumbLinks = [{ path: '/app/supplier/dashboard/', title: 'پیشخوان' }, { title: 'خدمات رفاهی من' }];
