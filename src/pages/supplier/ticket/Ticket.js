...
const Ticket = () => {
    ...
    const [breadCrumbLinks, setBreadCrumbLinks] = useState([
        {path: '/supplier', title: 'پیشخوان'},
        {path: '/app/supplier/management-tickets', title: 'پشتیبانی'},
        {path: `/app/supplier/management-tickets/${ticketId}`, title: ` جزییات تیکت ${ticketId}#`},
    ]);
    ...
    const getTicket = () => {
        ...
        (async () => {
            await SupplierService.get(`tickets/${ticketId}`, {signal})
                .then((res) => {
                ...
                <Grid container mt="30px" spacing="20px">
                    ...
                    <Grid item xs={7.5}>
                        <DBox sx={{p: '20px 0'}}>
                                                ...
                                                <Form>
                                                    <Grid columnSpacing={8} rowSpacing="14px" container>
                                                        ...
                                                        <Grid item xs={12} md={12}>
                                                            ...
                                                            <p style={textHelper}>پسوند های مجاز: .zip, .jpg, .jpeg,
                                                                .png, .rar, .txt, .pdf
                                                        ...
                                                        <Grid
                                                            ...
                                                            <Button
                                                                ...
                                                                sx={{
                                                                    fontSize: '14px',
                                                                    boxShadow: 'none', ...whiteButtonStyle
                                                                }}
                                                                onClick={() => {
                                                                    setExpanded(false)
                                                                    // resetForm({values: ''})
                                                            ...
                                                            <LoadingButton
                                                                ...
                                                                sx={{
                                                                    fontSize: '14px',
                                                                    boxShadow: 'none', ...yellowButtonStyle
                                                                }}>
                                                                ارسال
                                                            </LoadingButton>
                                                        </Grid>
                            ...
                            <Link style={{textDecoration: 'none', width: '100%', display: 'grid'}}
                                  to={`/app/supplier/management-tickets`}>
                                <Box
                                    sx={{
                                        p: '6px 0',
                                        display: 'flex',
