...
const Tickets = () => {
    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            await SupplierService.get(`tickets?${params.toString()}`)
                .then((res) => {
    ...
    const closeTicket = async (id) => {
        ...
        await SupplierService.closeTicket(id)
            .then((res) => {
                setShowDeleteDialog(false);
                setFilters({...filters});
                setSnackBarData({
            ...
            <DBox
                ...
                <DLoadingWrapper loading={loading.initial}>
                    <Grid container spacing={'2rem'} justifyContent={"space-between"}
                        ...
                        <Grid height="4rem" m=".3rem 0 2rem" item xs={5} className="flex" justifyContent="flex-end"
                              gap="1.5rem">
                            <Button
                                variant="contained"
                                color="brandWarning"
                                    ...
                                    {tickets.length > 0 ? (
                                        tickets.map((ticket, index) => (
                                            ...
                                            <TicketListItem
                                                ...
                                                baseUrl="/app/supplier/management-tickets/"
