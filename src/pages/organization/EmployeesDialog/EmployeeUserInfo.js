...
function EmployeeInfoDialogUserInfo({ employeeId, onClose, onSave }) {
    ...
    const handleSubmit = async (values, actions) => {
        ...
        // queryString.append('company_level', values.company_level);
        queryString.append('status', checked ? 'ACTIVE' : 'DEACTIVATE');

        updateEmployee(queryString.toString(), actions);
    };
