...
import NewServiceDocuments from './NewServiceDocuments';
...
function AddService({
    ...
    //! this is for Ddroupdown

    const handleSelectedDocuments = (data) => {
        console.log(data, 'handleSelectedDocuments =>');
    };
    ...
    useEffect(() => {
        if (type.basic) setTitle((prev) => 'خدمت عمومی');
        else if (type.company) setTitle((prev) => 'خدمت سازمانی');
        else setTitle(() => '');
    }, [type]);
    ...
    const rowTwoProvinceSelected = (province, setProvince) => {
    ...
    supplierId && queryString.append(`supplier_id`, supplierId);
                    ...
                    <Grid mt="1.5rem" item xs={7}>
                        <Grid container>
                            ...
                            <Grid item xs={4} mr="auto" mb={margin}>
                                <CustomInputNumber sx={inputStyle} name="price" placeholder={'مبلغ (تومان)'} />
                            </Grid>
                        ...
                        <Grid container>
                            <Grid item xs={12}>
                                <NewServiceDocuments
                                    ...
                                    onSelect={handleSelectedDocuments}
                                />
                            </Grid>
                        </Grid>
                    </Grid>
